...
@Component({
  selector: 'app-add-edit-vendor-doctor',
  templateUrl: './add-edit-vendor-doctor.component.html',
  styleUrls: ['./add-edit-vendor-doctor.component.css']
})
export class AddEditVendorDoctorComponent implements OnInit {
